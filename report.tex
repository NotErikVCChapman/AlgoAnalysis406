...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{ITALC 3.2.1.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{ITALC 3.2.1.2.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{ITALC 3.2.2.jpg}
    \caption{ITALC 3.2.2}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{ITALC 4.4.1.jpg}
    \caption{ITALC 4.4.1}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{ITALC 4.4.2.jpg}
    \caption{ITALC 4.4.2}
    \label{fig:enter-label}
\end{figure}
